...
const Navbar = () => {
  ...
  const [listPlaceOpen, setListPlaceOpen] = useState(false);
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <button
                onClick={() => setListPlaceOpen(true)}
                className="text-sm bg-background text-foreground hover:font-semibold border border-border rounded-full px-3 mx-2 py-1 h-[42px] shadow-sm transition-all duration-150 hover:shadow-md hover:-translate-y-[1px]"
              >
                List your place
              </button>
              <button
      ...
      <Dialog open={listPlaceOpen} onOpenChange={setListPlaceOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="text-center items-center">
            <div className="mx-auto mb-2 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10">
              <Smartphone className="h-7 w-7 text-primary" />
            </div>
            <DialogTitle className="text-xl font-parkinsans">
              Download the Spotnere App
            </DialogTitle>
            <DialogDescription className="text-center pt-1">
              For a better experience and easy registration, download the
              Spotnere app to list your place and manage it on the go.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <a
              href="#"
              className="inline-flex items-center gap-3 bg-black text-white rounded-xl px-5 py-3 hover:opacity-80 transition-opacity"
            >
              <img
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-[10px] font-light">Available on the</span>
