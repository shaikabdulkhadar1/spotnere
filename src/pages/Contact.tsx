      ...
      <div className="pt-32 pb-12 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Contact Form */}
            <GlassCard hover={false} className="animate-fade-up" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="space-y-6 animate-fade-up" style={{ animationDelay: "0.2s" }}>
              <GlassCard className="group">
                ...
                <a
                  href="mailto:hello@spotnere.com"
              ...
              <GlassCard className="group">
                ...
                <a
                  href="mailto:business@spotnere.com"
                  className="text-primary hover:underline"
                >
                  business@spotnere.com
                </a>
              </GlassCard>
              ...
              <GlassCard className="group">
                ...
                <a
                  href="mailto:listings@spotnere.com"
                  className="text-primary hover:underline"
                >
                  listings@spotnere.com
                </a>
              </GlassCard>
